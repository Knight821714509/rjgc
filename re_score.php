 ...
 */
include "header.php";
include "controller/re_score_controller.php";
is_submit();
?>
...
<div class="container box-style" style="margin: auto;min-height: 800px;">
    <div class="text-center" style="width: 50%;margin: 0 auto;">
        <h1>修改成绩信息</h1>
        <form class="item-margin" action="re_score.php" method="get">
            <label for="">
        ...
        <form action="re_score.php" method="post">
            <?php
            select_block("uid");
            ?>
            <input class="form-control item-margin" name="grade" type="text" placeholder="学生成绩">
